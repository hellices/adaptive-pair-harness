...
describe("discoverHarnessSignals", () => {
  it("detects known coexistence signals without claiming active ownership", () => {
    const signals = discoverHarnessSignals({
      ...
      workspacePaths: [
        "AGENTS.md",
        "docs/superpowers/plans/2026-09-12-realtime-pair-vertical-slice.md",
        "docs\\superpowers\\plans\\2026-09-12-realtime-pair-vertical-slice.md",
      ],
    });
  ...
  it("matches Markdown plans directly under the Superpowers plans directory", () => {
    const signals = discoverHarnessSignals({
      extensionIds: [],
      workspacePaths: [
        "docs/superpowers/plans/custom-name.md",
        "docs/superpowers/plans/archive/nested.md",
      ],
    });
    ...
    expect(signals).toEqual([
      expect.objectContaining({
        ...
        source: "docs/superpowers/plans/custom-name.md",
      }),
    ]);
  });
